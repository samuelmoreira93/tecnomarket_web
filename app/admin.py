...
class ProductoAdmin(admin.ModelAdmin):
    list_display = ['nombre', 'precio','nuevo','categoria'] #Agregamos al admin las columnas que queremos ver
    ...
    list_filter = ['categoria','nuevo'] #definimos un filtro por parametros
